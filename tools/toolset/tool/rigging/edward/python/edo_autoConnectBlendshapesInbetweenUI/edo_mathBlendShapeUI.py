...
def edo_mathBlendShapeUI():
    ...
    cmds.optionMenu('edo_mathBlendShapeUI_OM01' ,label='      MATH   METHOD: ',cc=partial(edo_mathBlendShape_OM01_ccmd))
    cmds.menuItem( label='+' )
    cmds.menuItem( label='-' )
    cmds.menuItem( label='SkinCluster_inverse')
    cmds.textFieldButtonGrp('edo_mathBlendShapeUI_TFBG01',label='BASE_MESH',text='',buttonLabel='    Load    ',   cw3=[100,200,100],bc=partial(edo_loadTextListToTF,'edo_mathBlendShapeUI_TFBG01','mesh'))
    cmds.textFieldButtonGrp('edo_mathBlendShapeUI_TFBG02',label='BLENDSHAPE_A',text='',buttonLabel='    Load    ',cw3=[100,200,100],bc=partial(edo_loadTextListToTF,'edo_mathBlendShapeUI_TFBG02','mesh'))
    cmds.textFieldButtonGrp('edo_mathBlendShapeUI_TFBG03',label='BLENDSHAPE_B',text='',buttonLabel='    Load    ',cw3=[100,200,100],bc=partial(edo_loadTextListToTF,'edo_mathBlendShapeUI_TFBG03','mesh'))
    cmds.textFieldButtonGrp('edo_mathBlendShapeUI_TFBG04',label='TARGET_MESH',text='',buttonLabel='    Load    ', cw3=[100,200,100],bc=partial(edo_loadTextListToTF,'edo_mathBlendShapeUI_TFBG04','mesh'))
    cmds.textFieldButtonGrp('edo_mathBlendShapeUI_TFBG05',label='TWEAK',text='',buttonLabel='    Load    ',vis=0, cw3=[100,200,100],bc=partial(edo_loadTextListToTF,'edo_mathBlendShapeUI_TFBG05','tweak'))
    cmds.textFieldButtonGrp('edo_mathBlendShapeUI_TFBG06',label='SKINCLUSTER',text='',buttonLabel='    Load    ', cw3=[100,200,100],bc=partial(edo_loadTextListToTF,'edo_mathBlendShapeUI_TFBG06','skinCluster'),vis=0)
    cmds.setParent('edo_mathBlendShapeUI_CL01')
    cmds.button('edo_mathBlendShapeUI_BT01',label=' MATH THE BLENDSHAPES ',w=380,h=30,bgc=[0.83,0.67,0.28],c=partial(edo_mathBlendShapeBT01_cmd))
    cmds.button('edo_mathBlendShapeUI_BT02',label=' stop compute ',w=380,h=30,bgc=[0.83,0.17,0.18],vis=1,  c=partial(edo_mathBlendShapeUI_BT02_cmd))
    cmds.showWindow('edo_mathBlendShapeUI')
    cmds.window('edo_mathBlendShapeUI',e=1,w=380,h=300)

def edo_mathBlendShapeUI_BT02_cmd(*arg):
    global edo_geometryComputer_compute
...
def edo_mathBlendShape_OM01_ccmd(*arg):
...
def edo_mathBlendShapeBT01_cmd(*arg):
    mathMethod=cmds.optionMenu('edo_mathBlendShapeUI_OM01',q=1,v=1)
