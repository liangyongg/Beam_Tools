...
def edo_createUnderWorldBlendShapeUI():
    ELPLUGIN.edo_loadPlugin('underworldBlendShape.mll')
    ...
    cmds.textFieldButtonGrp('deform_Mesh', label='deform Mesh:            ',text='',buttonLabel='load selected',bc=partial(edo_loadDeformMesh))
    cmds.textFieldButtonGrp('original_Mesh', label='original Mesh:          ',text='',buttonLabel='load selected',bc=partial(edo_loadorgMesh))
    cmds.textFieldButtonGrp('underworld_dirven_Mesh', label='underworld dirven Mesh: ',text='',buttonLabel='load selected',bc=partial(edo_loaduwMesh))
    cmds.textFieldButtonGrp('underworld_base_Mesh', label='underworld base Mesh:   ',text='',buttonLabel='load selected',bc=partial(edo_loaduwbMesh))
    cmds.textFieldButtonGrp('blendShape_Meshes', label='blendShape Meshes:   ',text='',buttonLabel='load selected',bc=partial(edo_loadbsMesh))
    cmds.button('createButton',l='create underworldBlendShape deformer',ann='',c=partial(edo_finalButtonCmd))
