...
class Vec4(MathObject):
    ...
    def __init__(self, x=0.0, y=0.0, z=0.0, t=0.0):
        ...
        if bs.getRTValTypeName(x) == 'Vec4':
            self._rtval = x
        else:
            self._rtval = bs.rtVal('Vec4')
    ...
    def t(self, value):
        ...
        self._rtval.t = bs.rtVal('Scalar', value)
    ...
    def set(self, x, y, z, t):
        ...
        self._rtval.set('', bs.rtVal('Scalar', x), bs.rtVal('Scalar', y),
                        bs.rtVal('Scalar', z), bs.rtVal('Scalar', t))
    ...
    def multiplyScalar(self, other):
        ...
        return Vec4(self._rtval.multiplyScalar('Vec4', bs.rtVal('Scalar', other)))
    ...
    def divideScalar(self, other):
        ...
        return Vec4(self._rtval.divideScalar('Vec4', bs.rtVal('Scalar', other)))
    ...
    def linearInterpolate(self, other, t):
        ...
        return Vec4(self._rtval.linearInterpolate('Vec4', bs.rtVal('Scalar', t)))
