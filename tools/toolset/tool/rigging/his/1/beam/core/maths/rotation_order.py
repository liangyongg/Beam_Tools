...
from rigging.beam.core.maths.constants import ROT_ORDER_INT_TO_STR_MAP
from rigging.beam.core.maths.constants import ROT_ORDER_STR_TO_INT_MAP
...
class RotationOrder(MathObject):
    ...
    def __init__(self, order=4):
        ...
        if bs.getRTValTypeName(order) == 'RotationOrder':
            self._rtval = order
        else:
            self._rtval = bs.rtVal('RotationOrder')
    ...
    def order(self, value):
        ...
        self._rtval.order = bs.rtVal('Integer', value)
