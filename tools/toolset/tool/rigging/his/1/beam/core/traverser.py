...
from rigging.beam.core.objects.constraints.constraint import Constraint
from rigging.beam.core.objects.operators.operator import Operator


class Traverser(object):
    """beam base traverser for any scene item.
    ...
    def addRootItem(self, item):
        ...
        #print "Traverser.addRootItem._rootItems: ",self._rootItems
        return True
