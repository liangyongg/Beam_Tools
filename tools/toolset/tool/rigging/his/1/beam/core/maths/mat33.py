...
class Mat33(MathObject):
    ...
    def __init__(self, row0=None, row1=None, row2=None):
        ...
        if bs.getRTValTypeName(row0) == 'Mat33':
            self._rtval = row0
        else:
            self._rtval = bs.rtVal('Mat33')
    ...
    def row0(self, value):
        ...
        self._rtval.row0 = bs.rtVal('Vec3', value)
    ...
    def row1(self, value):
        ...
        self._rtval.row1 = bs.rtVal('Vec3', value)
    ...
    def row2(self, value):
        ...
        self._rtval.row2 = bs.rtVal('Vec3', value)
    ...
    def setRows(self, row0, row1, row2):
        ...
        self._rtval.setRows('', bs.rtVal('Vec3', row0), bs.rtVal('Vec3', row1), bs.rtVal('Vec3', row2))
    ...
    def setColumns(self, col0, col1, col2):
        ...
        self._rtval.setColumns('', bs.rtVal('Vec3', col0), bs.rtVal('Vec3', col1), bs.rtVal('Vec3', col2))
    ...
    def equal(self, other):
        ...
        return self._rtval.equal('Boolean', bs.rtVal('Mat33', other)).getSimpleType()
    ...
    def almostEqual(self, other, precision=None):
        ...
        if precision is not None:
            return self._rtval.almostEqual('Boolean', bs.rtVal('Mat33', other), bs.rtVal('Scalar', precision)).getSimpleType()
        else:
            return self._rtval.almostEqual('Boolean', bs.rtVal('Mat33', other)).getSimpleType()
    ...
    def add(self, other):
        ...
        return Mat33(self._rtval.add('Mat33', bs.rtVal('Mat33', other)))
    ...
    def subtract(self, other):
        ...
        return Mat33(self._rtval.subtract('Mat33', bs.rtVal('Mat33', other)))
    ...
    def multiply(self, other):
        ...
        return Mat33(self._rtval.multiply('Mat33', bs.rtVal('Mat33', other)))
    ...
    def multiplyScalar(self, other):
        ...
        return Mat33(self._rtval.multiplyScalar('Mat33', bs.rtVal('Scalar', other)))
