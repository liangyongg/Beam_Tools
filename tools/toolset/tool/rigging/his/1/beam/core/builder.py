...
from rigging.beam.core.objects.scene_item import SceneItem
...
class Builder(object):
    ...
    def __buildSceneItem(self, kObject, phase):
        ...
        if kObject.isTypeOf("Rig"):
            if phase == self._buildPhase_3DObjectsAttributes:
                ...
                print "__buildSceneItem.dccSceneItem: buildContainer"

        elif kObject.isTypeOf("Layer"):
            if phase == self._buildPhase_3DObjectsAttributes:
                dccSceneItem = self.buildLayer(kObject, buildName)
                print "__buildSceneItem.dccSceneItem: buildLayer"
            ...
            if phase == self._buildPhase_3DObjectsAttributes:
                ...
                print "__buildSceneItem.dccSceneItem: buildGroup"

        elif kObject.isTypeOf("HierarchyGroup"):
            if phase == self._buildPhase_3DObjectsAttributes:
                dccSceneItem = self.buildHierarchyGroup(kObject, buildName)
                print "__buildSceneItem.dccSceneItem: buildHierarchyGroup"
            ...
            if phase == self._buildPhase_3DObjectsAttributes:
                ...
                print "__buildSceneItem.dccSceneItem: buildScalarAttribute"
            elif phase == self._buildPhase_AttributeConnections:
                self.connectAttribute(kObject)
            ...
            if phase == self._buildPhase_3DObjectsAttributes:
                ...
                print "__buildSceneItem.dccSceneItem: buildIntegerAttribute"
            elif phase == self._buildPhase_AttributeConnections:
                self.connectAttribute(kObject)
            ...
            if phase == self._buildPhase_3DObjectsAttributes:
                ...
                print "__buildSceneItem.dccSceneItem: buildStringAttribute"
            elif phase == self._buildPhase_AttributeConnections:
                self.connectAttribute(kObject)
    ...
    def _postBuild(self, kSceneItem):
        ...
        if os.environ.get('KRAKEN_DCC', None) is not None:
            ...
            if len(invalidOps) > 0:
                print "logger.warn(Non-evaluated Operators:)"
            ...
            if len(invalidConstraints) > 0:
                print "logger.warn(Non-evaluated Constraints:)"
    ...
    def logOrphanedGraphItems(self, kSceneItem):
        ...
        if len(orphanedObjects) > 0:
            print "logger.warn(Orphaned objects found:)"
