...
from rigging.beam.core.maths import MathObject, Mat44, Vec2, Vec3, Xfo
...
from rigging.beam.core.kraken_system import bs
    ...
    def evaluate(self):
        ...
        for i in xrange(self.node.getExecPortCount()):
            ...
            if portDataType in ('EvalContext', 'time', 'frame'):
                portVal = bs.constructRTVal(portDataType)
            ...
            if portConnectionType == 'In':
                if str(portDataType).endswith('[]'):
                    ...
                    rtValArray = bs.rtVal(portDataType)
