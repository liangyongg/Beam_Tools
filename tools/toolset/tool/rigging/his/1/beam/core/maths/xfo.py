...
class Xfo(MathObject):
    ...
    def __init__(self, tr=None, ori=None, sc=None):
        ...
        if bs.getRTValTypeName(tr) == 'Xfo':
            self._rtval = tr
            print "Xfo(MathObject).bs.getRTValTypeName(tr) == 'Xfo'"
            print "Xfo(MathObject).self._rtval: ",self._rtval
        else:
            self._rtval = bs.rtVal('Xfo')
            if isinstance(tr, Xfo):
                self.set(tr=tr.tr, ori=tr.ori, sc=tr.sc)
                print "isinstance(tr, Xfo): (tr.tr, tr.ori, tr.sc)",(tr.tr, tr.ori, tr.sc)
            else:
                if tr is not None:
                    self.tr = tr
                if ori is not None:
                ...
                if sc is not None:
                    self.sc = sc
                print "self.tr",tr,"self.ori",ori,"self.sc",sc
    ...
    def tr(self, value):
        ...
        self._rtval.tr = bs.rtVal('Vec3', value)
    ...
    def ori(self, value):
        ...
        self._rtval.ori = bs.rtVal('Quat', value)
    ...
    def sc(self, value):
        ...
        self._rtval.sc = bs.rtVal('Vec3', value)
    ...
    def set(self, tr, ori, sc):
        ...
        self._rtval.set('', bs.rtVal('Vec3', tr), bs.rtVal('Quat', ori),
                        bs.rtVal('Vec3', sc))
    ...
    def setFromMat44(self, m):
        ...
        return Xfo(self._rtval.setFromMat44('Xfo', bs.rtVal('Mat44', m)))
    ...
    def multiply(self, xfo):
        ...
        return Xfo(self._rtval.multiply('Xfo', bs.rtVal('Xfo', xfo)))
    ...
    def transformVector(self, v):
        ...
        return Vec3(self._rtval.transformVector('Vec3', bs.rtVal('Vec3', v)))
    ...
    def transformRay(self, ray):
        ...
        # return Ray(self._rtval.transformRay('Ray', bs.rtVal('Ray', ray)))
    ...
    def inverseTransformVector(self, vec):
        ...
        return Vec3(self._rtval.inverseTransformVector('Vec3', bs.rtVal('Vec3', vec)))
    ...
    def linearInterpolate(self, other, t):
        ...
        return Xfo(self._rtval.linearInterpolate('Xfo', bs.rtVal('Xfo', other),
                                                 bs.rtVal('Scalar', t)))
