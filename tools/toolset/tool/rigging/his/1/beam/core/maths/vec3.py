...
class Vec3(MathObject):
    ...
    def __init__(self, x=0.0, y=0.0, z=0.0):
        ...
        if bs.getRTValTypeName(x) == 'Vec3':
            self._rtval = x
            print "Vec3.self._rtval",self._rtval
        else:
            self._rtval = bs.rtVal('Vec3')
            if isinstance(x, Vec3):
                self.set(x=x.x, y=x.y, z=x.z)
                print "Vec3.self.set(x=x.x, y=x.y, z=x.z)",x.x,x.y,x.z
            else:
                self.set(x=x, y=y, z=z)
                print "Vec3.self.set(x=x, y=y, z=z)",x,y,z
    ...
    def x(self, value):
        ...
        self._rtval.x = bs.rtVal('Scalar', value)
    ...
    def y(self, value):
        ...
        self._rtval.y = bs.rtVal('Scalar', value)
    ...
    def z(self, value):
        ...
        self._rtval.z = bs.rtVal('Scalar', value)
    ...
    def set(self, x, y, z):
        ...
        self._rtval.set('', bs.rtVal('Scalar', x), bs.rtVal('Scalar', y), bs.rtVal('Scalar', z))
    ...
    def almostEqual(self, other, precision):
        ...
        return self._rtval.almostEqual('Boolean', other._rtval, bs.rtVal('Scalar', precision)).getSimpleType()
    ...
    def setComponent(self, i, v):
        ...
        self._rtval.setComponent('', bs.rtVal('Size', i),
                                        bs.rtVal('Scalar', v))
    ...
    def multiplyScalar(self, other):
        ...
        return Vec3(self._rtval.multiplyScalar('Vec3', bs.rtVal('Scalar', other)))
    ...
    def divideScalar(self, other):
        ...
        return Vec3(self._rtval.divideScalar('Vec3', bs.rtVal('Scalar', other)))
    ...
    def linearInterpolate(self, other, t):
        ...
        return Vec3(self._rtval.linearInterpolate('Vec3', other._rtval, bs.rtVal('Scalar', t)))
