...
def rtValToPyObject_DFGHost(dfgHost, rtVal):
  return CAPI.RTValToPyObject_DFGHost(dfgHost, rtVal)

def pyObjectToRTVal(context, rtVal):
  return CAPI.PyObjectToRTVal(context, rtVal)

def pyObjectToRTVal_DFGHost(dfgHost, rtVal):
  return CAPI.PyObjectToRTVal_DFGHost(dfgHost, rtVal)
