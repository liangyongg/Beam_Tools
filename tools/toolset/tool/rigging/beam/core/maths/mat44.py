...
class Mat44(MathObject):
    ...
    def __init__(self, row0=None, row1=None, row2=None, row3=None):
        ...
        if bs.getRTValTypeName(row0) == 'Mat44':
            self._rtval = row0
        else:
            self._rtval = bs.rtVal('Mat44')
    ...
    def row0(self, value):
        ...
        self._rtval.row0 = bs.rtVal('Vec4', value)
    ...
    def row1(self, value):
        ...
        self._rtval.row1 = bs.rtVal('Vec4', value)
    ...
    def row2(self, value):
        ...
        self._rtval.row2 = bs.rtVal('Vec4', value)
    ...
    def row3(self, value):
        ...
        self._rtval.row3 = bs.rtVal('Vec4', value)
    ...
    def setRows(self, row0, row1, row2, row3):
        ...
        self._rtval.setRows('', bs.rtVal('Vec4', row0), bs.rtVal('Vec4', row0),
                            bs.rtVal('Vec4', row2), bs.rtVal('Vec4', row3))
    ...
    def setColumns(self, col0, col1, col2, col3):
        ...
        self._rtval.setColumns('', bs.rtVal('Vec4', col0), bs.rtVal('Vec4', col0),
                               bs.rtVal('Vec4', col2), bs.rtVal('Vec4', col3))
    ...
    def setDiagonal(self, v):
        ...
        self._rtval.setDiagonal('', bs.rtVal('Scalar', v))
    ...
    def setDiagonal(self, v):
        ...
        self._rtval.setDiagonal('', bs.rtVal('Vec3', v))
    ...
    def equal(self, other):
        ...
        return self._rtval.equal('Boolean', bs.rtVal('Mat44', other)).getSimpleType()
    ...
    def almostEqual(self, other, precision):
        ...
        return self._rtval.almostEqual('Boolean', bs.rtVal('Mat44', other),
    ...
    def almostEqual(self, other):
        ...
        return self._rtval.almostEqual('Boolean', bs.rtVal('Mat44', other)).getSimpleType()
    ...
    def add(self, other):
        ...
        return Mat44(self._rtval.add('Mat44', bs.rtVal('Mat44', other)))
    ...
    def subtract(self, other):
        ...
        return Mat44(self._rtval.subtract('Mat44', bs.rtVal('Mat44', other)))
    ...
    def multiply(self, other):
        ...
        return Mat44(self._rtval.multiply('Mat44', bs.rtVal('Mat44', other)))
    ...
    def multiplyScalar(self, other):
        ...
        return Mat44(self._rtval.multiplyScalar('Mat44', bs.rtVal('Scalar', other)))
    ...
    def multiplyVector(self, other):
        ...
        return Vec3(self._rtval.multiplyVector('Vec3', bs.rtVal('Vec3', other)))
