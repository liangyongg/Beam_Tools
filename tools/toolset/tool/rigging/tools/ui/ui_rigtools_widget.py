...
class ui_rigtools_widget(QtGui.QWidget):

    def __init__(self,parent=None):
        super(ui_rigtools_widget,self).__init__(parent)
        self.setupUi()

    def setupUi(self):
        self.mainVboxLayout = QtGui.QVBoxLayout(self)
        path = self.current_path()
        self.main_Widget = self.loadUiWidget(os.path.join(path,"rigtools.ui"))
